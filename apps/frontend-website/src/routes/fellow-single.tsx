...
function Content ( { className }: React.ComponentProps<"main"> ) {
	return <main className={ className }>
		<IntroSection className="md:flex md:gap-1g" />
...
function TestimonialSection ( { className }: React.ComponentProps<"section"> ) {
	return <section className={ className }>
...
function FellowsWordsSection ( { className }: React.ComponentProps<"section"> ) {
	return <section className={ className }>
		<hr className="border-black" />
...
function CreditsSection ( { className }: React.ComponentProps<"section"> ) {
	return <section className={ className }>

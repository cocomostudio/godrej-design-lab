...
export default function ThisPage() {
  return (
    <section className="container flex max-md:flex-col md:gap-1g">
      <div className="md:w-2c-1g lg:w-3c-2g">
        First column content goes here...
      </div>

      <div className="md:w-6c-5g lg:w-9c-8g bg-rose-400">
        <div>
          Second column content goes here... ... and can have its own children
          that are styled based on the global grid
        </div>

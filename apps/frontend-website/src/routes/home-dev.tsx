  ...
  return (
    <section className={className}>
      <div className="flex items-start md:items-center justify-between gap-2">
        <h2 className="text-h1 font-bold uppercase text-midnight-blue flex-1 pr-4">
          Fellowship
        </h2>
        <button className="shrink-0 px-4 py-2 md:px-5 md:py-2.5 lg:px-6 lg:py-[15px] rounded-md bg-dodger-blue text-xs md:text-sm lg:text-[20px] text-white uppercase">
          See all
        </button>
      </div>
...
function DesignSeries({ className }: React.ComponentProps<"section">) {
  return (
    <section className={className}>
      <div className="flex items-start md:items-center justify-between gap-2">
        <h2 className="text-h1 font-bold uppercase flex-1 pr-4">
          design series
        </h2>
        <button className="shrink-0 px-4 py-2 md:px-5 md:py-2.5 lg:px-6 lg:py-[15px] rounded-md bg-dodger-blue text-xs md:text-sm lg:text-[20px] text-white uppercase">
          See all

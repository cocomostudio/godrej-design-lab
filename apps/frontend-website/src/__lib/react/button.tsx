...
const Button = <C extends ElementType = typeof default_element>( {
	...
	const combined_class_name = `inline-block rounded-md bg-secondary text-white px-3 py-3.5 md:px-3.75 md:py-2.25 lg:px-6 lg:py-3.75 text-xs lg:text-sm uppercase ${ className }`
